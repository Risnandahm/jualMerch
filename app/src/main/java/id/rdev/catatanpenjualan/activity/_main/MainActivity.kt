...
import id.rdev.catatanpenjualan.activity.data_merch.DataMerchActivity
import id.rdev.catatanpenjualan.activity.login.LoginActivity
import id.rdev.catatanpenjualan.activity.penjualan.PenjualanMerch
...
class MainActivity : BaseActivity(), MainView {
    ...
    private fun initActionButton() {
        mainMenu.adapter = MenuAdapter(object : MenuAdapter.OnMenuClick {
            override fun onClick(image: Int) {
                ...
                when(image) {
                    R.drawable.ic_goods -> openDataMerch()
    ...
    private fun openDataPenjualan() {
        Log.d(TAG, "Penjualan")
        startActivity<PenjualanMerch>(TAGS.USER to user)
    }

    private fun openDataMerch() {
        Log.d(TAG, "Data Merch")
        startActivity<DataMerchActivity>(TAGS.USER to user)
    }
